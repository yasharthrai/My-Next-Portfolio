          ...
          <div className="space-y-6">
            ...
            <div className="pt-4">
              <a 
                ...
                className="inline-block px-6 py-2 border border-accent-light text-accent-light hover:bg-accent-light hover:text-dark transition-all text-sm"
              >
                connect on linkedin
              </a>
            </div>
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-3">
              {skills.map((skill) => (
                <span
                  key={skill}
                  className="px-4 py-2 text-sm border border-accent/50 text-accent-light minimal-border-hover"
                >
                  {skill}
                </span>
              ))}
